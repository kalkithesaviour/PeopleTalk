					...
					<div class="container">
						<div class="row">
							<form action="" method='post' enctype="multipart/form-data" data-toggle="validator" class="form-horizontal">
								...
								<div class="col-lg-3">
									<div class="form-group">
										<br> <br> <input type="file" name="photo" class="form-control" id="changephoto" required />
									</div>
								</div>
								<div class="col-lg-3 ">
									<div class="form-group">
					...
					<div class="container">
						<form action="" method='post' data-toggle="validator" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<select class="form-control" name="state" class="form-control" id="listBox" onchange='selct_district(this.value)'></select>
								</div>
							</div>
							<div class="form-group">
