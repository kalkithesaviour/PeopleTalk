			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="login" method="post" data-toggle="validator" class="form-horizontal">
								...
								<div style="float:right;" class="g-recaptcha" data-sitekey="6LegGy8gAAAAAIsK51ir6P1avNB5_uCCtypmNmTu"></div>
								<div class="form-group">
									<div class="col-lg-10 col-lg-offset-3">
										<sec:csrfInput />
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="loginGoogle" class="navbar-form navbar-left">
								<div class="form-group">
